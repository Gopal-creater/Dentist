...
export default function About() {
    ...
    return (
        <div>
            ...
            <div className="navbar_about" data-aos="fade-right" data-aos-duration="3000">
                <NavBar />
            </div>
            ...
            <div className="about_longtext" data-aos="fade-up" data-aos-duration="3000">
            ...
            <div className="about_image_2" data-aos="fade-right" data-aos-duration="3000">
                <div className="about_patch_2"></div>
                <div className="about_doctor_image_2">
                    <img src={Expert} />
                </div>
            </div>
            <div className="about_longtext_2" data-aos="fade-up" data-aos-duration="3000">
            ...
            <div className="about_heading_2 text-center" data-aos="fade-up" data-aos-duration="3000">
